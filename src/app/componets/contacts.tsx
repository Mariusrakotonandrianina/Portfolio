...
export default function Contacts({
  ...
  const validateEmailJSConfig = () => {
    ...
    if (!emailjsConfig.templateId)
      missingKeys.push("NEXT_PUBLIC_EMAILJS_TEMPLATE_ID");
      ...
      <div className="relative z-10 w-full px-4 sm:px-6 md:px-8 lg:px-12">
        ...
        >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 lg:items-start">
                ...
                >
                  ...
                  >
                    ...
                    <div className="relative z-10 flex items-center gap-4">
                      ...
                      <div>
                        <h4
                          className={`text-lg font-bold bg-gradient-to-r ${contact.titleGradient} bg-clip-text text-transparent`}
                        >
                          {contact.type}
                        </h4>
            ...
            <motion.div variants={formVariants} className="relative lg:mt-16">
              <motion.div
