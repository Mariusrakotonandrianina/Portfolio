        ...
        >
          ...
          >
            ...
            <p className="text-base sm:text-lg md:text-xl text-[hsl(var(--muted-foreground))] max-w-2xl mx-auto px-4">
              Découvrez mes compétences techniques acquises au fil de mes
                ...
                >
                  ...
                  >
                    <div className="flex items-center gap-2 sm:gap-3 mb-4 sm:mb-6">
                      ...
                      <h3
                        className={`text-base sm:text-lg lg:text-xl font-bold bg-gradient-to-r ${category.titleGradient} bg-clip-text text-transparent leading-tight`}
                      >
                        {category.category}
                      </h3>
                    </div>
